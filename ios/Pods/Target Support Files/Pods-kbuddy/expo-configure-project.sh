...
with_node \
  ...
  --target "/Users/parkjongjoon/project/k-buddy/ios/Pods/Target Support Files/Pods-kbuddy/ExpoModulesProvider.swift" \
  --entitlement "/Users/parkjongjoon/project/k-buddy/ios/kbuddy/kbuddy.entitlements" \
  --platform "apple" \
